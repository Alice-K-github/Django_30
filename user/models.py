...
class Pays(models.Model):
    ...
    payed_kurs = models.ForeignKey('school.Kurs', on_delete=CASCADE, verbose_name="Оплаченный курс", null=True, blank=True)
    payed_lesson = models.ForeignKey('school.Lesson', on_delete=CASCADE, verbose_name="Оплаченный урок", null=True, blank=True)
